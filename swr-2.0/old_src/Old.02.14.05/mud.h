...
typedef struct	extracted_char_data	EXTRACT_CHAR_DATA;typedef struct	char_data		CHAR_DATA;
...
/* The minimum number of supporters required to found a clan. */
#define MIN_SUPPORTERS          3

/* Money transactions greater than this value will be logged. */
#define LARGE_TRANSACTION       5000000
...
bool        clan_name_valid         (char* name);
