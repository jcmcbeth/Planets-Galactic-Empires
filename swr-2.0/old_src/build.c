...
"trade", "bank", "gym", "safe", "mail", "information", "cloning",
"shipyard", "barracks", "r16", "no_edit", "r18", "restaurant",
"plr_home", "empty_home", "train", "hotel", "nofloor", "pawn", "supply",
"bar", "employment", "spacecraft", "medbay", "auction"
};
...
"device", "droid_corpse", "resource", "air",
"extinguish", "token", "chemical", "module", "engine",
"bug"
};
...
*/
	...
	send_to_char( "  clan vip wanted password\n\r",                  ch );
	send_to_char( "\n\r",						ch );
...
*/
	...
	if ( !argument || argument[0] == '\0' )
	{
	   ...
	   send_to_char( "Possible Types:\n\r", ch );
           ...
           send_to_char( "Device      Chemical   Module     Engine\n\r", ch );	   
           return;
	}
...
void do_redit( CHAR_DATA *ch, char *argument )
{
	...
	send_to_char( "  tunnel exdistance\n\r",			ch );
	return;
    }
