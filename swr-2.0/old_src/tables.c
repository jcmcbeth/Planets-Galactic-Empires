...
DO_FUN *skill_function( char *name )
{
	...
	if ( !str_cmp( name, "do_clans" ))		return do_clans;
        if ( !str_cmp( name, "do_clancreate" ))         return do_clancreate;
        if ( !str_cmp( name, "do_clandescription" ))    return do_clandescription;
        if ( !str_cmp( name, "do_clanmembers" ))        return do_clanmembers;
        if ( !str_cmp( name, "do_clanremove" ))         return do_clanremove;
	...
	if ( !str_cmp( name, "do_goship" ))		return do_goship;
	...
	if ( !str_cmp( name, "do_haul" ))		return do_haul;
	...
	if ( !str_cmp( name, "do_installmodule" ))	return do_installmodule;
	...
	if ( !str_cmp( name, "do_loadup" ))		return do_loadup;
        if ( !str_cmp( name, "do_loadship" ) )          return do_loadship;
	...
	if ( !str_cmp( name, "do_makemedpack" ))	return do_makemedpack;
	if ( !str_cmp( name, "do_makemodule" ))          return do_makemodule;
	...
	if ( !str_cmp( name, "do_planets" ))		return do_planets;
        if ( !str_cmp( name, "do_plantbug" ) )          return do_plantbug;
	...
	break;
    case 'q':
	if ( !str_cmp( name, "do_quickarmor" ))		return do_quickarmor;
	...
	if ( !str_cmp( name, "do_removemodule" ))	return do_removemodule;
	...
	if ( !str_cmp( name, "do_setmulti" ))	        return do_setmulti;
	...
	if ( !str_cmp( name, "do_showmulti" ))	        return do_showmulti;
	...
	if ( !str_cmp( name, "do_slayship" ))		return do_slayship;
	...
	if ( !str_cmp( name, "do_suicide" ))		return do_suicide;
        if ( !str_cmp( name, "do_support" ))            return do_support;
	...
	if ( !str_cmp( name, "do_unfoldarea" ))		return do_unfoldarea;
        if ( !str_cmp( name, "do_unloadship" ) )        return do_unloadship;
...
{   
    if ( skill == do_plantbug ) return "do_plantbug";
    if ( skill == do_loadship ) return "do_loadship";
    if ( skill == do_unloadship ) return "do_unloadship";
	if ( skill == do_cloak ) return "do_cloak";
    if ( skill == do_bounties)	return "do_bounties";
	if ( skill == do_bounty ) return "do_bounty";
    if ( skill == do_setmulti )     return "do_setmulti";
    ...
    if ( skill == do_haul )     return "do_haul";
    ...
    if ( skill == do_quickarmor )     return "do_quickarmor";
    if ( skill == do_makearmor )     return "do_makearmor";
    if ( skill == do_makemodule )     return "do_makemodule";
    ...
    if ( skill == do_clandescription )  return "do_clandescription";
    if ( skill == do_sellship )         return "do_sellship";
    if ( skill == do_renameship )         return "do_renameship";
    if ( skill == do_giveship )         return "do_giveship";
    ...
    if ( skill == do_clanremove )       return "do_clanremove";
    if ( skill == do_clancreate )       return "do_clancreate";
    if ( skill == do_clanmembers )      return "do_clanmembers";
...
*/    if ( skill == do_east )		return "do_east";
    ...
    if ( skill == do_found )            return "do_found";
    ...
    if ( skill == do_goship )		return "do_goship";
    ...
    if ( skill == do_installmodule )	return "do_installmodule";
    ...
    if ( skill == do_makemedpack )	return "do_makemedpack";
    ...
    if ( skill == do_removemodule )	return "do_removemodule";
    ...
    if ( skill == do_slayship )		return "do_slayship";
    ...
    if ( skill == do_support )          return "do_support";
