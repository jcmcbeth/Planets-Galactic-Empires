...
#define MIN_SUPPORTERS          3           /* The minimum number of supporters required to found a clan.   */

#define LARGE_TRANSACTION       5000000     /* Money transactions greater than this value will be logged.   */

#define HOURS_PER_GAMEYEAR      4           /* How many hours equals an in-game year.                       */
...
typedef enum
{
  ...
  CON_GET_REFFERAL,	CON_COPYOVER_RECOVER
} connection_types;
...
struct space_data
{
    ...
    SHIP_DATA  * last_ship;
    ASTEROID_DATA * first_roid;
    ASTEROID_DATA * last_roid;
...
struct asteroid_data {
	SPACE_DATA	*system;
	ASTEROID_DATA	*next; //in system
	ASTEROID_DATA	*prev; //in system
	SHIP_DATA	*towedby;
	char		*name;
	int		x;
	int		y;
...
#define REVOLT_CLAN_NAME            "Militia"           /* The clan name that will be used for planets that have revolted.              */

#define CLAN_TIME_TILL_INACTIVE     (3600 * 24 * 3)     /* The amount of time that has to pass for a clan to be considered inactive.    */
#define CLAN_TIME_TILL_DEAD         (3600 * 24 * 14)    /* The amount of time that has to pass for a clan to be considered dead.        */
#define CLAN_CEASEFIRE_TIME         (3600 * 24 * 2)     /* The amount of time before a clan can be warred.                              */

#define MEMBER_TIME_TILL_INACTIVE   (3600 * 24 * 3)     /* The amount of time before a member is considered inactive.                   */

/**
 * Member powers flags.
 */
#define POWER_NONE          0;      /* To clear all powers.                 */
#define POWER_WITHDRAW      BV00    /* The power to withdraw clan funds.    */
#define POWER_BUYSHIP       BV01    /* The power to buy clan ships.         */
#define POWER_INDUCT        BV02    /* The power to induct new members.     */
#define POWER_BUILD         BV03    /* The power to build on clan planets.  */
#define POWER_EMPOWER       BV04    /* The power to empower others.         */
#define POWER_PILOT         BV05    /* The power to pilot clan ships.       */
#define POWER_WAR           BV06    /* The power to war other clans         */
#define POWER_WAGES         BV07    /* The power to set wages               */
#define POWER_OUTCAST       BV08    /* The power to outcast players         */
#define POWER_MAX_FLAGS     9       /* The number of power flags.           */

/**
 * Clan flags.
 */
#define CLAN_HIDDEN        BV00
#define CLAN_MAX_FLAGS     1

/**
 * These are the ranks that someone in a clan can have.
 */
typedef enum
{
    RANK_NONE = -1, /* If the character is unclanned.   */
    RANK_MEMBER,    /* A normal member of the clan.     */     
    RANK_LEADER     /* A person that is a leader and has access to the leader commands. */
} clan_rank;

#define MAX_RANK RANK_LEADER    /* The maximum rank you can have. */
#define MIN_RANK RANK_MEMBER    /* The minimum rank you can have. */

/**
 * This is to keep up with the members that are in the clan, their rank,
 * and how long ago they last played. This needs to be keept in the clan
 * because the clan is always loaded into memory while characters are only
 * loaded into memory when they are logged in. So this is so we don't have
 * to check all the player files to see who is in the clan, their rank, and
 * how active they are.
 */
struct member_data
{
    MEMBER_DATA*     next;          /* The next member in the list.     */
    MEMBER_DATA*     prev;          /* The previous member in the list. */
    char*            name;          /* The name of the player.          */
    sh_int           rank;          /* Uses the clan_rank enumeration.  */
    long int         powers;        /* The powers the member has.       */
    time_t           last_played;   /* The last time the player was on. */    
};

/**
 * This stores the data pertaining to a clan.
 */
struct clan_data
{    
    CLAN_DATA*      next;           /* Next clan in the list.                                   */
    CLAN_DATA*      prev;           /* Previous clan in the list.                               */ 
    MEMBER_DATA*    first_member;   /* The first member in the clan.                            */
    MEMBER_DATA*    last_member;    /* The last member in the clan.                             */
    char*           filename;       /* Clan filename                                            */
    char*           name;           /* Clan name                                                */
    char*           description;    /* A brief description of the clan                          */    
    char*           atwar;          /* A namelist of the clans that this clan is at war with.   */
    sh_int          members;        /* Number of clan members                                   */
    long int        funds;          /* How much money the clan has.                             */
    int             spacecraft;     /* Number of spacecraft owned by the clan.                  */
    int             vehicles;       /* Number of vehicles owned by the clan.                    */
    int             salary;         /* How much the clan pays a player hourly.                  */    
    time_t          created;        /* The time at which the clan was formed.                   */    
};
...
struct ship_data
{
    ...
    bool        autopilot;
    int		price; //phel
    ASTEROID_DATA *towing;
    char*       customshipstring;
    int         modules;
    int         module[25];
    int        flags;
    long	bounty;
...
#define MOB_VNUM_DOCTOR			31
#define MOB_VNUM_TRAINER		32
#define MOB_VNUM_DROID			205

/*
 * Planet Flags.
 */
#define PLANET_INVADABLE	BV00
#define PLANET_CAPTURABLE	BV01
#define PLANET_PLAYEREDITABLE	BV02
#define PLANET_NOBOMB		BV03
#define PLANET_HIDDEN		BV04
#define PLANET_CRAPY            BV05
#define PLANET_REVOLTING        BV06
#define PLANET_RESERVED2 BV07
#define PLANET_RESERVED3 BV08
#define PLANET_RESERVED4 BV09
#define PLANET_RESERVED5 BV10
#define PLANET_RESERVED6 BV11
#define PLANET_RESERVED7 BV12
#define PLANET_RESERVED8 BV13
#define PLANET_RESERVED9 BV14
#define PLANET_RESERVED10 BV15
#define PLANET_RESERVED11 BV16
#define PLANET_RESERVED12 BV17
#define PLANET_RESERVED13 BV18
#define PLANET_RESERVED14 BV19
#define PLANET_RESERVED15 BV20
#define PLANET_RESERVED16 BV21
#define PLANET_RESERVED17 BV22
#define PLANET_RESERVED18 BV23
#define PLANET_RESERVED19 BV24
#define PLANET_RESERVED20 BV25
#define PLANET_RESERVED21 BV26
#define PLANET_RESERVED22 BV27
#define PLANET_RESERVED23 BV28
#define PLANET_RESERVED24 BV29
#define PLANET_RESERVED25 BV30
#define PLANET_RESERVED26 BV31

// Space System flags
#define SPACE_NOASTEROIDS BV00
#define SPACE_RESERVED2 BV01
#define SPACE_RESERVED3 BV02
#define SPACE_RESERVED4 BV03
#define SPACE_RESERVED5 BV04
#define SPACE_RESERVED6 BV05
#define SPACE_RESERVED7 BV06
#define SPACE_RESERVED8 BV07
#define SPACE_RESERVED9 BV08
#define SPACE_RESERVED10 BV09
#define SPACE_RESERVED11 BV10
#define SPACE_RESERVED12 BV11
#define SPACE_RESERVED13 BV12
#define SPACE_RESERVED14 BV13
#define SPACE_RESERVED15 BV14
#define SPACE_RESERVED16 BV15
#define SPACE_RESERVED17 BV16
#define SPACE_RESERVED18 BV17
#define SPACE_RESERVED19 BV18
#define SPACE_RESERVED20 BV19
#define SPACE_RESERVED21 BV20
#define SPACE_RESERVED22 BV21
#define SPACE_RESERVED23 BV22
#define SPACE_RESERVED24 BV23
#define SPACE_RESERVED25 BV24
#define SPACE_RESERVED26 BV25
#define SPACE_RESERVED27 BV26
#define SPACE_RESERVED28 BV27
#define SPACE_RESERVED29 BV28
#define SPACE_RESERVED30 BV29
#define SPACE_RESERVED31 BV30
#define SPACE_RESERVED32 BV31

// Ship flags for ships, so they can have flags.
// Replace the reserved ones with which ever ones you feel like.
// Just make sure you also change ship_flags in space.c.
#define SHIP_CLOAKED BV00
#define SHIP_RESERVED1 BV01
#define SHIP_RESERVED2 BV02
#define SHIP_RESERVED3 BV03
#define SHIP_RESERVED4 BV04
#define SHIP_RESERVED5 BV05
#define SHIP_RESERVED6 BV06
#define SHIP_RESERVED7 BV07
#define SHIP_RESERVED8 BV08
#define SHIP_RESERVED9 BV09
#define SHIP_RESERVED10 BV10
#define SHIP_RESERVED11 BV11
#define SHIP_RESERVED12 BV12
#define SHIP_RESERVED13 BV13
#define SHIP_RESERVED14 BV14
#define SHIP_RESERVED15 BV15
#define SHIP_RESERVED16 BV16
#define SHIP_RESERVED17 BV17
#define SHIP_RESERVED18 BV18
#define SHIP_RESERVED19 BV19
#define SHIP_RESERVED20 BV20
#define SHIP_RESERVED21 BV21
#define SHIP_RESERVED22 BV22
#define SHIP_RESERVED23 BV23
#define SHIP_RESERVED24 BV24
#define SHIP_RESERVED25 BV25
#define SHIP_RESERVED26 BV26
#define SHIP_RESERVED27 BV27
#define SHIP_RESERVED28 BV28
#define SHIP_RESERVED29 BV29
#define SHIP_RESERVED30 BV30
#define SHIP_RESERVED31 BV31
...
#define SF_NOTEACH		  BV30  /* can't teach skill to another player */
...
#define OBJ_VNUM_TOOLKIT             30
#define OBJ_VNUM_PLASTIC             31
#define OBJ_VNUM_STEEL               34
#define OBJ_VNUM_LAST_PART	     38  /* last randomly placed object */
#define OBJ_VNUM_TOKEN               46
#define OBJ_VNUM_CHEMICALS           47
...
#define OBJ_VNUM_LATEX               98
#define OBJ_VNUM_LAST_FABRIC         99


#define OBJ_VNUM_PACKAGE             100

#define OBJ_VNUM_MEDKIT              118

/* MODULE TYPES */
typedef enum
{
  MODULE_NONE, MODULE_LOCKDOWN, MODULE_SPEED, MODULE_FUELTANK,
  MODULE_TRACTORBEAM, MODULE_MANUEVER, MODULE_CLOAK
} module_types;
...
typedef enum
{
  ...
  ITEM_DEVICE, ITEM_DROID_CORPSE, ITEM_RESOURCE, ITEM_AIR,
  ITEM_EXTINGUISH, ITEM_TOKEN, ITEM_CHEMICAL, ITEM_MODULE, ITEM_ENGINE,
  ITEM_BUG
} item_types;


#define MAX_ITEM_TYPE		     ITEM_BUG
/*
 * Extra flags.
 * Used in #OBJECTS.
 */
...
struct	pc_data
{
    ...
    sh_int		num_skills;
    sh_int		adept_skills;    
    char*               supports;       /* The name of another player that this player supports to found a clan. */
};
...
struct	system_data
{
    ...
    char *	multiplayers;		/* Multiplay allowed people */
...
#define IS_IMMORTAL(ch)		(ch->top_level >= 150 )
...
extern		BUG_DATA	  *	first_bug;
extern		BUG_DATA	  *	last_bug;
 ...
 */
DECLARE_DO_FUN( do_clanmembers );
DECLARE_DO_FUN( do_clancreate );
DECLARE_DO_FUN( do_clanremove );
DECLARE_DO_FUN( do_found );
DECLARE_DO_FUN( do_support );
DECLARE_DO_FUN( do_clandescription);
DECLARE_DO_FUN( do_plantbug );
DECLARE_DO_FUN( do_unloadship );
DECLARE_DO_FUN( do_loadship );
DECLARE_DO_FUN( do_cloak );
DECLARE_DO_FUN( do_bounties );
DECLARE_DO_FUN( do_bounty );
DECLARE_DO_FUN( do_release );
DECLARE_DO_FUN( do_haul );
DECLARE_DO_FUN( do_clone );
DECLARE_DO_FUN( do_copyover );
DECLARE_DO_FUN( do_arrest );
DECLARE_DO_FUN( do_setmulti );
DECLARE_DO_FUN( do_showmulti );
...
#define USERBUG_FILE	SYSTEM_DIR "userbugs.txt" /* For bug command     */
...
int get_planetflag( char * flag );

/* space.c */
SH        *  get_ship          	    args( ( char *name ) );
SHIP_DATA *  get_ship_filename      args( ( char *name ) );
...
ASTEROID_DATA  * get_asteroid_here      args( ( char *name , SPACE_DATA *starsystem ) );
...
bool	     ship_to_hangar	    args( ( SHIP_DATA *ship, ROOM_INDEX_DATA *hangar ) );
...
OBJ_DATA*   fread_obj_simple       (FILE* file);
...
int     str_str                 (const char* str, const char* find_str, int start);
